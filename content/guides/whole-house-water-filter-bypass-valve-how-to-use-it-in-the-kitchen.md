...
faq:
  - question: "Is bypass water the same as filtered water?"
    answer: "No. Bypass means the water is going around the filter, not through it. Treat it as unfiltered water from that line."
  - question: "How long should the bypass stay on?"
    answer: "Only for the time needed to complete the service job. Once the housing is closed and the system is back together, return to normal flow and flush the line."
  - question: "Why does the faucet sputter after switching back?"
    answer: "Air in the line is the most common reason. Run the faucet until the stream steadies and the sputtering stops."
  - question: "Do I need a bypass if I already have a shutoff valve?"
    answer: "Not always. A shutoff stops water completely, while a bypass keeps water moving around the filter. Use a bypass when you want the kitchen to stay active during service, and use shutoff when a full stop is easier."
---

## Start Here

That matters in a kitchen because the sink gets used constantly. Coffee, cooking, dish prep, and sometimes a refrigerator line all make any change to the water path obvious fast. The bypass is useful when you need the system open, but it only helps if you move it back to normal as soon as the job is done.
...
1. Clear the cabinet floor so you can reach the housing and the valve.
2. Turn off the feed to the filter system.
3. Open the kitchen faucet to release pressure.
4. Move the bypass valve into the bypass position.
5. Open the housing, change the cartridge, or handle the repair.
6. Reassemble the housing carefully so the seal seats evenly.
7. Return the valve to normal flow.
8. Run the water until the stream steadies and the sputtering stops.
9. Wipe the cabinet dry and put tools back in one place.
