...
description: "The easiest place to run a whole-house filter pressure check is the kitchen because the cold tap gives a steady draw and keeps the water heater out."
schema_type: FAQPage
...
faq:
  - question: "Do I need two gauges?"
    answer: "Two gauges make the reading easier to understand because you can see the pressure drop directly. One gauge still works if you keep a baseline and compare it after each filter change."
  - question: "Why use the kitchen cold faucet?"
    answer: "It is the easiest household tap to repeat month after month, and cold water keeps the heater and mixing valve out of the reading."
  - question: "What if the pressure looks fine but the flow feels weak?"
    answer: "A pressure check only shows restriction. If the pressure is steady but the faucet still feels weak, the aerator, stop valve, regulator, or another part of the plumbing may be involved."
  - question: "How often should I do this?"
    answer: "A monthly note is enough for many homes. After a line flush, a main repair, or any sudden change in flow, run the check again sooner so you have a fresh baseline."
---
...
1. Turn off dishwasher, laundry, irrigation, and anything else that can pull water.
2. Put the filter in its normal operating position. If there is a bypass, leave it in the filtered position for the first reading.
3. Read the gauge with no fixtures running.
4. Open the kitchen cold faucet fully for 30 to 60 seconds.
5. Read the gauge again while the faucet is still running, or note the upstream and downstream readings if you have two gauges in place.
6. If you have two gauges, subtract the outlet pressure from the inlet pressure.
7. If you have one gauge, compare the new reading with the clean baseline you wrote down after the last filter change.
8. Record the date, the reading, and whether other water use was shut off.
