...
faq:
  - question: "Do I need a bypass valve for a whole-house filter?"
    answer: "Yes. It lets you keep water flowing while you service or replace the filter."
  - question: "Is the kitchen sink filter easier than a whole-house install?"
    answer: "Usually, yes. A kitchen setup stays under one cabinet and does not require cutting the main line."
  - question: "Where should sediment filtration go in the line?"
    answer: "It usually belongs before a softener or other downstream equipment so grit does not load those parts."
  - question: "What makes a house harder to filter?"
    answer: "Old galvanized pipe, a leaky shutoff, slab access, and cramped crawlspaces are the usual trouble spots."
---
...
2. Open a nearby faucet and drain the pressure from the line.
3. Mark the cut-in section and plan the bypass route.
4. Install shutoff valves and unions so the filter can be removed later.
5. Mount the filter housing or tank with enough clearance underneath and to the side.
6. Connect the inlet and outlet in the correct direction.
7. Tighten the fittings evenly and avoid forcing plastic threads.
8. Restore water slowly and inspect each joint for drips.
9. Flush the system until the water runs clear and loose debris is out of the line.
