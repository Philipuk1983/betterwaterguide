---
title: "Water Softener vs Whole-House Sediment Filter: What to Install First"
slug: "water-softener-vs-whole-house-sediment-filter-what-to-install-first"
keyword_id: 40526052
...
summary: "If the water is clear but leaves scale behind, start with a softener. If the water carries sand, rust, or visible grit, start with a sediment filter."
description: "If the water is clear but leaves scale behind, start with a softener. If the water carries sand, rust, or visible grit, start with a sediment filter."
schema_type: FAQPage
...
faq:
  - question: "Does a sediment filter go before a softener?"
    answer: "Yes. If both systems are installed, the sediment filter should sit upstream so grit does not reach the softener."
  - question: "Can a softener replace a sediment filter?"
    answer: "No. A softener removes hardness minerals. It does not remove sand, rust, or visible particles."
  - question: "What micron rating should I start with?"
    answer: "A 20-micron cartridge is the easier place to start when flow matters. A 5-micron cartridge catches finer debris, but it loads faster and can reduce pressure sooner."
  - question: "What test tells me the order fastest?"
    answer: "Use a hardness strip, a clear-jar settle test, and a pressure gauge. TDS alone does not tell you whether the issue is hardness or sediment."
---
...
1. Test hardness.
2. Look for visible particles.
3. Use a clear jar and let it sit for 24 hours.
4. Check pressure before choosing a tight filter.
